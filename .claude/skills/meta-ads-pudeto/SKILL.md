...
```bash
/Users/martindlouhy/Projects/nastroje/meta-ads-app/run.sh <command> [flags]
```

If `/Users/martindlouhy/Projects/nastroje/meta-ads-app` is still literally in this file, STOP and ask the user for the app path (install step was skipped — see skill/INSTALL.md in the repo).

Command reference: `/Users/martindlouhy/Projects/nastroje/meta-ads-app/README.md` (full flag tables) and `/Users/martindlouhy/Projects/nastroje/meta-ads-app/docs/api-notes.md` (API behavior & quirks). Read them when unsure — this skill deliberately does not duplicate flags.
...
- `/Users/martindlouhy/Projects/nastroje/meta-ads-app/docs/api-notes.md` — API quirks; read when an API call fails unexpectedly.
