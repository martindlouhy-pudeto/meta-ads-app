...
```bash
VID=$(/Users/martindlouhy/Projects/nastroje/meta-ads-app/run.sh video-upload --file new.mp4 --wait --json | jq -r .id)
HASH=$(/Users/martindlouhy/Projects/nastroje/meta-ads-app/run.sh image-upload --file thumb.jpg --json | jq -r .hash)
/Users/martindlouhy/Projects/nastroje/meta-ads-app/run.sh creative-clone --creative-id <OLD> --name "V2" \
...
sys.path.insert(0, '/Users/martindlouhy/Projects/nastroje/meta-ads-app')
